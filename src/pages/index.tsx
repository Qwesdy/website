            ...
            <main className="mx-auto grid max-w-3xl grid-cols-6 gap-6 px-6 pt-16">
                        ...
                        >
                            ...
                            <span className="flex flex-1 flex-col justify-between p-6 text-white">
                                ...
                                <div className="space-y-0.5">
                                    ...
                                    <p className="text-sm">
                                        Drum and bass to send you to sleep, or
                                        host afters with.
                                    </p>
                                </div>
                            </span>
                ...
                {/* <div className="group relative col-span-3 flex h-full min-h-[13rem] flex-shrink-0 overflow-hidden rounded-2xl">
                    ...
                    <div className="absolute left-1/2 top-1/2 z-10 flex w-full flex-shrink-0 -translate-x-1/2 -translate-y-1/2 flex-col items-center space-y-2">
                        <div
                            aria-hidden
                            className="absolute translate-y-[14px]"
                        >
                ...
                <div className="col-span-6 space-y-2 rounded-2xl bg-yellow-200 p-6 md:col-span-4 dark:bg-indigo-800">
                    ...
                    <p>
                        Hi. My name is Alistair, I'm a software engineer from
                        the UK. I've been programming for as long as I can
                        remember. I am currently super busy working on{' '}
                    ...
                    <p>
                        Beyond programming, I'm really into drum &amp; bass, and
                        I'll often be found DJing or messing around in Ableton
